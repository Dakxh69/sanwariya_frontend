...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: const GlassBottomNav(currentPath: '/detail'),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        '(33 reviews)',
                        style: Theme.of(context).textTheme.labelSmall?.copyWith(color: AppTheme.outlineVariant),
                      ),
                    ],
                  ),
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border.symmetric(
                                  vertical: BorderSide(color: AppTheme.outlineVariant.withValues(alpha: 0.3)),
                                ),
                              ),
                              child: Text(
                                _quantity.toString(),
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton.icon(
                          ...
                          icon: const Icon(Icons.favorite_border, color: AppTheme.onSurface),
                          label: Text('Wishlist', style: Theme.of(context).textTheme.labelMedium?.copyWith(color: AppTheme.onSurface)),
                        ),
                      ),
                      const SizedBox(width: 16),
                      Expanded(
                        child: OutlinedButton.icon(
                          ...
                          label: Text('Share', style: Theme.of(context).textTheme.labelMedium?.copyWith(color: AppTheme.onSurface)),
                        ),
                      ),
                    ],
                  ),
