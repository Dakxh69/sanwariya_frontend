          ...
          children: [
            ...
            ShaderMask(
              shaderCallback: (bounds) => const LinearGradient(
                colors: [AppTheme.primary, AppTheme.primaryContainer, AppTheme.primary],
              ).createShader(bounds),
            ...
            Center(
              child: Column(
                children: [
                  const Icon(Icons.auto_awesome, color: AppTheme.primaryContainer, size: 48),
                  const SizedBox(height: 24),
                  Text(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(border: Border(bottom: BorderSide(color: AppTheme.primary))),
                  child: Text(
                    'REQUEST APPOINTMENT',
                    style: Theme.of(context).textTheme.labelSmall?.copyWith(
                          color: AppTheme.primary,
