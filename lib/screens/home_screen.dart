      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: showBottom ? 100 : 48),
          ],
        ),
      ),
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            bottom: 64,
            child: isDesktop
                ? _HeroContentDesktop(context: context)
                : _HeroContentMobile(context: context),
          ),
        ],
      ),
    );
...
class _HeroContentMobile extends StatelessWidget {
  ...
  const _HeroContentMobile({required this.context});
...
class _HeroContentDesktop extends StatelessWidget {
  final BuildContext context;
  const _HeroContentDesktop({required this.context});
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: hPad,
            child: isDesktop
                ? _ArtisanDesktopLayout(context: context)
                : _ArtisanMobileLayout(context: context),
          ),
        ],
      ),
    );
...
class _ArtisanMobileLayout extends StatelessWidget {
  final BuildContext context;
  const _ArtisanMobileLayout({required this.context});
  ...
  Widget build(BuildContext ctx) {
    return Container(
      ...
      width: double.infinity,
      height: MediaQuery.of(ctx).size.width * (4 / 3) - 48,
      child: _ArtisanImageStack(context: ctx),
    );
  }
}

class _ArtisanDesktopLayout extends StatelessWidget {
  final BuildContext context;
  const _ArtisanDesktopLayout({required this.context});
...
class _ArtisanImageStack extends StatelessWidget {
  final BuildContext context;
  const _ArtisanImageStack({required this.context});
...
class _AestheticQuote extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final hPad = Responsive.horizontalPadding(context);
    return Padding(
      padding: hPad.copyWith(top: 80, bottom: 80),
      child: Column(
        children: [
          Text(
            '"',
